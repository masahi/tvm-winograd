...
def decl_V(data, kernel,  stride, padding, out_dtype):
    ...
    def compute_temp(b, c, eps, nu, bb, cc):
        ...
        w = (b*bnb+bb) % nW * m
        temp_expr = {}
        temp_expr[(0,0)] = data_pad[batch_index][c][h+0][0+w][cc] - data_pad[batch_index][c][h+2][0+w][cc]
        temp_expr[(0,1)] = data_pad[batch_index][c][h+0][1+w][cc] - data_pad[batch_index][c][h+2][1+w][cc]
        temp_expr[(0,2)] = data_pad[batch_index][c][h+0][2+w][cc] - data_pad[batch_index][c][h+2][2+w][cc]
        temp_expr[(0,3)] = data_pad[batch_index][c][h+0][3+w][cc] - data_pad[batch_index][c][h+2][3+w][cc]
        temp_expr[(1,0)] = data_pad[batch_index][c][h+1][0+w][cc] + data_pad[batch_index][c][h+2][0+w][cc]
        temp_expr[(1,1)] = data_pad[batch_index][c][h+1][1+w][cc] + data_pad[batch_index][c][h+2][1+w][cc]
        temp_expr[(1,2)] = data_pad[batch_index][c][h+1][2+w][cc] + data_pad[batch_index][c][h+2][2+w][cc]
        temp_expr[(1,3)] = data_pad[batch_index][c][h+1][3+w][cc] + data_pad[batch_index][c][h+2][3+w][cc]
        temp_expr[(2,0)] = data_pad[batch_index][c][h+2][0+w][cc] - data_pad[batch_index][c][h+1][0+w][cc]
        temp_expr[(2,1)] = data_pad[batch_index][c][h+2][1+w][cc] - data_pad[batch_index][c][h+1][1+w][cc]
        temp_expr[(2,2)] = data_pad[batch_index][c][h+2][2+w][cc] - data_pad[batch_index][c][h+1][2+w][cc]
        temp_expr[(2,3)] = data_pad[batch_index][c][h+2][3+w][cc] - data_pad[batch_index][c][h+1][3+w][cc]
        temp_expr[(3,0)] = data_pad[batch_index][c][h+1][0+w][cc] - data_pad[batch_index][c][h+3][0+w][cc]
        temp_expr[(3,1)] = data_pad[batch_index][c][h+1][1+w][cc] - data_pad[batch_index][c][h+3][1+w][cc]
        temp_expr[(3,2)] = data_pad[batch_index][c][h+1][2+w][cc] - data_pad[batch_index][c][h+3][2+w][cc]
        temp_expr[(3,3)] = data_pad[batch_index][c][h+1][3+w][cc] - data_pad[batch_index][c][h+3][3+w][cc]
    ...
    def compute_V(b, c, eps, nu, bb, cc):
        v_expr = {}
        v_expr[(0, 0)] = temp[b][c][0][0][bb][cc] - temp[b][c][0][2][bb][cc]
        v_expr[(0, 1)] = temp[b][c][0][1][bb][cc] + temp[b][c][0][2][bb][cc]
        v_expr[(0, 2)] = temp[b][c][0][2][bb][cc] - temp[b][c][0][1][bb][cc]
        v_expr[(0, 3)] = temp[b][c][0][1][bb][cc] - temp[b][c][0][3][bb][cc]
        v_expr[(1, 0)] = temp[b][c][1][0][bb][cc] - temp[b][c][1][2][bb][cc]
        v_expr[(1, 1)] = temp[b][c][1][1][bb][cc] + temp[b][c][1][2][bb][cc]
        v_expr[(1, 2)] = temp[b][c][1][2][bb][cc] - temp[b][c][1][1][bb][cc]
        v_expr[(1, 3)] = temp[b][c][1][1][bb][cc] - temp[b][c][1][3][bb][cc]
        v_expr[(2, 0)] = temp[b][c][2][0][bb][cc] - temp[b][c][2][2][bb][cc]
        v_expr[(2, 1)] = temp[b][c][2][1][bb][cc] + temp[b][c][2][2][bb][cc]
        v_expr[(2, 2)] = temp[b][c][2][2][bb][cc] - temp[b][c][2][1][bb][cc]
        v_expr[(2, 3)] = temp[b][c][2][1][bb][cc] - temp[b][c][2][3][bb][cc]
        v_expr[(3, 0)] = temp[b][c][3][0][bb][cc] - temp[b][c][3][2][bb][cc]
        v_expr[(3, 1)] = temp[b][c][3][1][bb][cc] + temp[b][c][3][2][bb][cc]
        v_expr[(3, 2)] = temp[b][c][3][2][bb][cc] - temp[b][c][3][1][bb][cc]
        v_expr[(3, 3)] = temp[b][c][3][1][bb][cc] - temp[b][c][3][3][bb][cc]
        now = tvm.const(0.0, "float32")
        for ii in range(4):
            for jj in range(4):
                now = tvm.select(tvm.all(eps == ii, nu == jj),
...
def test_components(batch, in_channel, in_size, num_filter, kernel, stride, padding, device):
    ...
    with tvm.target.create(device):
        U_out, s_U = decl_U(A, W, stride, padding, dtype)
